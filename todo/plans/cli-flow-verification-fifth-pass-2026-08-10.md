...
| L-2     | NOT A BUG                                        | Fill-only source identity; the fill is load-bearing (`needsGlobalWrite`) and uninstall's `<id>@<marketplace>` registry keys depend on it. Never removed, by contract.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
