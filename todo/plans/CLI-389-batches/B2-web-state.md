...
incoherence shape), recorded to CLI-740 with a reopen trigger. (2) Groups #20/#24: the worksheet's
...
- **The attack (jotai + zustand in one app), weighed honestly.** The pair is the strongest
  ...
  catalogued_.
- **CLI-740 record + reopen trigger (the B12 pattern applied preemptively):** "jotai beside a
...
considered. This is NOT the CLI-740 accepted-loss case the worksheet paints; it costs nothing.
...
| ------------------------------------------------------ | ---------------------------------------- | --------------------------------------- | ----- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| jotai (web-state-jotai)                                | web-client-state                         | constrained-via-exclusivity-or-requires | B     | [react]                                                                   | none — existing `needsAny [react, nextjs, remix, react-native]` verified                                                                      | skill body (atoms, useAtom, Suspense — React-only); jotai.org                                                                                                                                                                             | The radio-attack candidate; sustained — see question (a). CLI-740 line + reopen trigger recorded.                                                                                                                                                                |
...
1. **§2b #24's structural-impossibility claim is false.** "tanstack-form is in both groups, so
   ...
   a CLI-740 accepted-loss case — a clean split.
...
| M8  | CLI-740 records                       | jotai-beside-store coexistence line (citing `jotai-zustand`/`atomWithStore`) + zustand-MUST reopen trigger (question a); tanstack-form svelte-widening trigger (F2)                                                                                                                                                |
