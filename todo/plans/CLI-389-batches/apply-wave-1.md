...
| 27  | `{ skill: "electron-updater", needs: ["electron"], reason: "electron-updater updates packaged Electron apps" }`             | B10 electron-updater (the electron-builder/Squirrel nuance is a CLI-740 record, not a rule)                                      |
