...
Scope: worksheet §B8, §4; relationship-coverage decisions 2/4; D-306 for anything the vocabulary
...
no-requires with a named D-306 nuance: wire-protocol reuse is not a skill dependency.**
...
- **F2 — modal is the catalog's Python-majority skill body** (7 `python` vs 3 `typescript`
  ...
  unaffected.
- **F3 — wire-protocol reuse is not a skill dependency (D-306 nuance, named once for the
...
- D-306 residue from this batch: wire-protocol reuse ≠ skill dependency (litellm/together-ai/
