...
- payload: NO rule (overturn) — CLI-740 recommends-shaped line + re-derive triggers live in the
  amended B7.
...
- The CLI-740 lines named across the five batches (trpc↔swr, hey-api-MUST tension, vite⊥nextjs
