...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------- | -------- | ---------- |
| SKILLS-10 (new, 2026-08-30) | **Three of four testers have no testing skill to carry.** `*-testing-*` exists for web, mobile and desktop only — there is no `api-testing-*`, `cli-testing-*` or `ai-testing-*`, so `api-tester`, `cli-tester` and `ai-tester` preload a framework and no test runner. Surfaced by the assignment-model proposal. | Ready for Dev | feature  | moderate   |
