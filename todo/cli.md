...
| ID      | Task                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Status        | Type     | Complexity |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------- | -------- | ---------- |
| CLI-819 | **Four E2E fixtures file a skill under a stack category the catalogue contradicts.** Thirteen literals key `"web-testing"` (once `"web-mocking"`) for `web-testing-cypress-e2e` / `web-testing-playwright-e2e`, whose declared category is `web-e2e` — derived from the id prefix, which `packages/cli/CLAUDE.md` forbids in fixtures. The correct lookup (`metadataFieldsFor`) is already used by the same fixtures for the metadata.yaml beside it. Invisible because `normalizeStackRecord` relocates the assignment on LOAD. **Filed rather than fixed because correcting it forces a fixture-identity decision**: `web-e2e` is exclusive, so `ProjectBuilder.dualScope()` cannot hold both skills, and one has to become a skill from another category across five specs in two files — which changes what `dual-scope.e2e.test.ts` -> _"should compile project agents referencing both global and project skills"_ covers. That spec currently asserts a compiled body no CLI-written config can produce. Reproduce with `CONFIG_ROUNDTRIP_PROBE=/tmp/probe.jsonl npx vitest --config e2e/vitest.config.ts --run --project e2e` (19 of 150 fixture configs fail the round trip). [Finding](../packages/cli/.ai-docs/agent-findings/2026-08-23-fixture-stack-categories-derived-from-id.md) | Needs Ruling  | fix      | medium     |
