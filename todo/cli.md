...
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- | -------- | ---------- |
| CLI-865 (new, 2026-09-02, found by the CLI-863 measurement, cause falsified 2026-09-02) | **`summary-panel.test.tsx` fails about 1 run in 10 under CPU contention.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Investigate      | fix      | medium     |
| CLI-889 (new, 2026-09-04, found while closing the test-integrity gaps)                  | **Seven shipped agents compile with unbalanced XML tags, so the trailing system-reminder is invisible to any depth-tracking read of their bodies.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Ready for Dev    | fix      | medium     |
| CLI-887 (new, 2026-09-03, found by the sweep re-verifying CLI-884)                      | **The carried-id collision guard is bypassable: `payload.marketplace` steers the catalogue it measures against.** [Finding](../packages/cli/.ai-docs/agent-findings/2026-09-03-the-external-skill-seat-is-the-one-writer-of-the-catalogue-that-takes-an-id-unconditionally.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Ready for Dev    | fix      | small      |
| CLI-885 (new, 2026-09-03, left by the carried-id collision fix)                         | **Owner ruling: should the receiver require the `external-` namespace outright, or only refuse actual collisions?** [Finding](../packages/cli/.ai-docs/agent-findings/2026-09-03-the-external-skill-seat-is-the-one-writer-of-the-catalogue-that-takes-an-id-unconditionally.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Needs Assistance | fix      | small      |
| CLI-886 (new, 2026-09-03, left by the carried-id collision fix)                         | **`edit --from` re-applying a payload that carries an external skill has no E2E leg, so the `local` carve-out is held by a unit spec alone.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Ready for Dev    | test     | small      |
| CLI-869 (new, 2026-09-02, left by the CLI-854 lane)                                     | **The wizard's Ink rendering still prints a hostile catalogue's `displayName` unsanitised, and closing it needs a ruling between two very different fixes.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Needs Assistance | fix      | medium     |
| CLI-868 (new, 2026-09-02, found by the CLI-855 lane)                                    | **`check-finding-citations.ts` reads any dated name in `todo/` as a finding, so a tracker link to a dated PLAN fails as a dangling citation.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Ready for Dev    | fix      | low        |
| CLI-847                                                                                 | **`skills-and-matrix.md`'s Relationship Query Functions row names `advisoryStateFrom` in `matrix/matrix-resolver.ts`, and neither it nor the `advisoryState` field it claims to fill exists anywhere in the monorepo.** By the bible's vanished-name rule the enclosing section is suspect, not just the sentence — the row and its "which no production module reads" note both need re-deriving against the real module. Found by the CLI-846 doc pass, reported rather than fixed because repairing it widens into machinery that pass had not read.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Ready for Dev    | bug      | simple     |
...
| ID      | Task                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Status           | Type     | Complexity |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- | -------- | ---------- |
| CLI-871 | (new, 2026-09-03) **Migrate the other sixteen agents to the voice the 2026-09-03 rewrite established.** `agent-summoner` and `skill-summoner` are written in it; the rest still carry `**(You MUST ...)**`, `→ STOP` checkpoints and `## CRITICAL` headings, mostly in `critical-requirements.md` and `critical-reminders.md`. They are current about the product and stale about the phrasing. Census: `grep -rlE '\*\*\(You MUST\|→ STOP\|## CRITICAL\|⚠️' packages/cli/src/agents/*/*/*.md`. `prompt-bible.md` §6 and `agent-summoner/playbook.md` step 4 both say so explicitly, so nothing is claiming otherwise while this waits. [Plan](./plans/summoner-context-engineering-2026-09-03.md) Fifteen of them also state a verification MUST in BOTH `critical-requirements.md` and `critical-reminders.md`, on top of the baseline's single positive statement — the same rule three times per compiled prompt, twice in the retired form; delete both copies and leave the baseline's. Widen `PROHIBITIONS` / `RETIRED_FORMS` in `agent-baseline-is-slim-and-positively-framed.test.ts` to the per-agent sources as each migrates, so the sixteenth cannot stay behind. **Ordering constraint:** the fourteen `(You MUST run tests…)` parentheticals and eight `- [ ] No type errors` / `- [ ] No lint errors` self-attestation rows across these agents are the only prompt text telling an agent to run tests, and the gate does NOT run tests (owner ruling 2026-09-03: a project's suite can exceed the 600 s hook timeout and fail open) — so the instruction to run tests survives in prompt text, rewritten once per agent in positive form, and only the duplicated `## CRITICAL` restatements go. **Exception when migrating `codex-keeper`:** its `**(You MUST re-read files after editing…)**` (in both `critical-requirements.md:11` and `critical-reminders.md:21`) is NOT a duplicate of the baseline — the baseline no longer carries a read-back, and the gate cannot see an edit that fails to land on a `.md` file, which is that role's entire output. Rewrite it once, positively, in `critical-requirements.md`; delete only the `critical-reminders.md` copy. | Ready for Dev    | refactor | medium     |
| CLI-872 | (new, 2026-09-03) **Every skill states a real trigger sentence and neither surface that needs one reads it.** `usageGuidance` is required by `metadata.schema.json` and all 238 marketplace skills carry a specific one (`meta-design-expressive-typescript`: "Use when writing or refactoring TypeScript functions, data transformations, store actions, or any code that mixes logic levels"). Two consumers throw it away. **(a)** `resolveAgentConfigToSkills` in `src/cli/lib/stacks/stacks-loader.ts` sets `usage: \`when working with ${category}\`` — derived from the category rather than read from the field — so every compiled agent's `<skill_activation_protocol>` says "Use when: when working with meta-design" where the skill said something specific. This is the inverse of the standing rule against deriving stated metadata from an id or path, and it is verifiable by eye: `node bin/run.js compile` from `packages/cli`, then read the tail of `~/.claude/agents/skill-summoner.md`. **(b)** The emitted `SKILL.md` frontmatter `description` — the only text loaded at startup and the sole basis on which a skill fires — carries `cliDescription`-grade text with no conditions; 95 of 238 `SKILL.md` files mention a "when" anywhere in the file, against 238 of 238 `metadata.yaml`. Fix (a) here; (b) needs scoping first, since the `SKILL.md` files live in `agents-inc/skills`. Census: `grep -lie "use when\|when you\|when building" $M/*/SKILL.md \| wc -l`against`ls $M/*/SKILL.md \| wc -l`, where `$M`is that repository's`src/skills`. Raised by the owner's Claude-5 context-engineering brief, 2026-09-03 — the one item in it not already at HEAD, though its diagnosis (that the interpolation "never worked") is wrong: it works and is fed a placeholder.                                                                                                                                                                                                                                                                                                                                                                                 | Ready for Dev    | bug      | medium     |
| CLI-873 | (new, 2026-09-03) **Add "enumerate before committing" to `prompt-bible.md` §1.** Where several implementations compile but only one is idiomatic, an agent should name two or three shapes a developer familiar with the codebase would consider, pick one, and say why. Targets the search failure where the model writes the first working shape rather than the right one. Nothing in the doctrine states it today — `grep -rn "enumerate" packages/cli/.ai-docs/standards/` is the check. Raised by the owner's Claude-5 context-engineering brief, 2026-09-03. [Plan](./plans/summoner-context-engineering-2026-09-03.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Ready for Dev    | refactor | easy       |
| CLI-875 | (new, 2026-09-03) **Two proposed clauses for `packages/cli/CLAUDE.md` → "Test Assertions", both raised by lanes that hit the gap and both left to the owner, since that file is theirs to curate.** **(a) Binding an expectation to repo-internal generator input.** The existing rule offers two rows — bind a SYMBOL whose deletion should break the test, or keep the literal for TEXT the product renders — and a value a generator copies out of a source file in this repository is in neither, so it resolves to the second and the pasted form is what the rule appears to ask for. `AGENT_SUMMONER_ENTRY` and `PM_ENTRY` in `scripts/generate-matrix-package.test.ts` each pasted an agent's whole `description`; the first reddened the moment that description was reworded. Proposed: read it from the source file, because the mirroring argument behind `e2e/pages/constants.ts` does not apply when the source file IS the authority — and prove such an expectation discriminates rather than tautologises, by pointing the generator at a mutated copy and checking the real expectation fails against it. **(b) Presence rosters over optional files.** The count rule governs HOW to assert a roster and is silent on WHETHER one is owed. `agent-partials.test.ts` asserted that every agent directory holds `critical-requirements.md` and `critical-reminders.md` while `readAgentFiles` reads both through `readFileOptional` and `agent.liquid` guards both — so an agent authored by following the shipped playbook's own optionality reddened the suite. Proposed: never assert a presence roster over files the product treats as optional; put the mechanism that makes the absence legal under assertion instead — which is the stronger claim, since losing the liquid guard compiles an empty wrapper around nothing and no partial assertion can reach that. Evidence: `.ai-docs/agent-findings/2026-09-03-a-spec-pasted-prose-from-a-source-file-in-its-own-repository.md` and `2026-09-03-a-gate-asserted-a-roster-over-files-the-product-documents-as-optional.md`.                                                                                     | Investigate      | refactor | easy       |
| CLI-877 | (new, 2026-09-03) **An external skill's trigger sentence reaches an agent by two routes that disagree, and one of them is missing a period.** `externalSkillMetadata` in `packages/cli/src/cli/lib/seed/external-skills.ts` writes `usageGuidance: Use when working with ${displayName}` into the installed skill's `metadata.yaml`, so the CLI reads it as that skill's stated guidance on the next load. The editor's preview has no such metadata and falls back to `statedUsageFor`'s `Use when working with ${category}.` — same skill, two different sentences in the same `<skill_activation_protocol>` list. Two sub-defects: the display name and the category are different things, and only one of the two spellings ends in a period, while all 238 catalogue values do. Settle which sentence an external skill gets and spell it once. Census: `grep -rn "Use when working with" packages/cli/src apps/editor/src --include='*.ts' \| grep -v test`. Found while landing CLI-872(a); not in that fix's lane.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Ready for Dev    | bug      | easy       |
| CLI-878 | (new, 2026-09-03) **Ten absence claims are each stated in two to four `.ai-docs` documents, against the bible's own one-owner rule.** A census over `.ai-docs/reference/` — absence vocabulary, then backticked identifiers resolving to zero hits across all seven workspaces, then a second pass for absences of a FIELD on a symbol that still exists, which the first pass structurally cannot see — found: `setAllSourcesEject`/`setAllSourcesPlugin` (**4 documents**), `RecompileAgentsOptions` has no `installMode` (3), no `CompileAndWriteParams` type (2), no `recompiledCount` field (2), `populateFromStack` removed (3 sites in 2 docs, one document stating it twice), the agent-removal path's missing parameter (2), the dead-marketplace surfacing behaviour (2), `baseFlags` undeclared (3 sites in 2), `maskCollidingGlobalAgents` identity-only (2), and the bare-id fall-through (4 sites in 3). **The sharpest is `recompiledCount`: both stating documents are unrouted for the file that declares the type, while `operations-layer.md` — which the hook table does route — already carries all four fields positively, so the absence is derivable there and merely asserted in the other two.** Two of the ten are plausible second-vantage claims rather than duplicates (`plugin-system.md`/`boundary-map.md` on the dead marketplace; `guard-pattern.md` on why the source setters were withdrawn), so this wants a vantage pass per entry rather than a mechanical sweep — the discriminator is whether the local context invites a reader toward the absent symbol. Also fix the form defect in the one correct owner: `config-writer.md` writes "`grep` returns nothing", naming the instrument and withholding the invocation, which the bible's "an absence names its symbol" rule asks to be written as the runnable command.                                                                                                                                                                                                                                                                                                                          | Ready for Dev    | refactor | medium     |
| CLI-879 | (new, 2026-09-03) **The poison guard checks named-to-planted and never planted-to-named, and has no nested analogue at all.** `packages/compile/src/agent-source.test.ts` holds `POISONED_AGENT` as `Required<AgentConfig>` and pins its string-valued TOP-LEVEL keys against `POISONED_AGENT_KEYS`, so a new top-level field carrying author text reddens. There is no equivalent for the nested hook types. A field added to `AgentHookAction` or `AgentHookDefinition` makes `Required<...>` fail `tsc` until it is filled — but filling it with a plain string satisfies the compiler, plants no marker, and no assertion notices, because `plants every marker it names` walks the roster and never walks the fixture. **That is the exact shape that let `hooks[].hooks[].type` ride the `...action` spread unsanitised**, caught on the guard's first run only because someone thought to look for it. Every field is covered today (`AgentHookDefinition` declares `matcher`/`hooks`; `AgentHookAction` declares `type`/`command`/`script`/`prompt`; all six plus the event key are enumerated in `sanitizeHooks`), so this is a gap in the guard rather than a live defect — which is why it wants fixing before the next nested field, not after. The fix is a planted-to-named direction on the nested rosters, or a structural equivalent of the top-level `Required<>` pin that a plain string cannot satisfy. Raised by the lane that pinned the gate composition; verified against the types rather than remembered.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Ready for Dev    | refactor | medium     |
| CLI-880 | (new, 2026-09-03) **Four standards carry `last_validated: 2026-04-21` over text rewritten today.** `prompt-bible.md` (1983→1179 lines), `skill-atomicity-bible.md` (1428→1226), `skill-atomicity-primer.md` and `loop-prompts-bible.md` were substantially rewritten for voice and structure without a whole-document re-derivation against source, and the documentation bible's staleness rule 1 says the date means exactly that. Leaving April is right after a partial pass; the defect is that nothing records which areas were left unverified — rule 5 asks for an `agent-findings/` entry naming them, and none exists. Either finish the pass per document and stamp it, or file the entry naming the sections rewritten without re-derivation (`prompt-bible.md` §7 Troubleshooting and §8.3–8.5 are the candidates the diff shows lightly touched). All four are also past the quarterly threshold on their own. Census: `grep -l 'last_validated: 2026-04-21' packages/cli/.ai-docs/standards/*.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Ready for Dev    | docs     | medium     |
| CLI-881 | (new, 2026-09-03) **The completion gate's "iterates rather than reporting done" promise breaks after eight blocks, and the gate cannot see it coming.** Read from the shipped Claude Code binary (2.1.259): a stop hook may block at most `CLAUDE_CODE_STOP_HOOK_BLOCK_CAP` (default 8) consecutive times before Claude Code overrides it and ends the turn, and on every repeat invocation it passes `stop_hook_active: true` on stdin so a hook can stand down gracefully. `COMPLETION_GATE_COMMAND` in `packages/compile/src/agent-source.ts` reads no stdin (`grep -c 'stdin\|jq\|stop_hook_active' ` over it returns 0), so on a persistently failing typecheck it blocks eight times, is overridden, and the agent reports done anyway — while every document describing the gate says the opposite. Two decisions: whether the gate should read `stop_hook_active` and, when set, emit the failing output as context and exit 0 rather than burn the cap; and whether the eight-block ceiling is worth stating to the agent so it knows the gate is not infinite. Also record `disableAllHooks` / `allowManagedHooksOnly` as a third condition under which the gate never runs, at every scope. And the hook timeout — 600 s default, per-hook lowerable — after which the gate's output is discarded and the turn proceeds. This is why `test` is excluded from the gate by owner ruling: a project's suite can exceed it and the gate fails OPEN. Typecheck on a very large project could in principle hit it too; a per-hook `timeout` on the emitted record would turn that into a block rather than a silent release. **Corrects the dispatch-1 record in the programme plan, which says `stop_hook_active` "is NOT in the documented Stop/SubagentStop contract" — the binary's SubagentStop input schema carries it, and the Agent SDK TypeScript reference types `SubagentStopHookInput.stop_hook_active: boolean`.** Found by the review's verifier; every claim above was reproduced against the binary.                                                                                                                                                                  | Ready for Dev    | bug      | medium     |
| CLI-882 | (new, 2026-09-03) **The editor's preview cannot forward a custom agent's `hooks`, because the type it reads never carries the field.** `GeneratedAgentDefinition` in `packages/matrix/src/generated/agents.ts` is produced by a `Pick<AgentYamlConfig, …>` in `packages/cli/scripts/generate-matrix-package.ts` that names `disallowedTools`, `permissionMode`, `isolation`, `experimental` and `outputFormat` — not `hooks`. So `compileAgents` in `apps/editor/src/features/configure/lib/output-preview.ts` now mirrors four of the CLI's five frontmatter spreads and structurally cannot mirror the fifth. Inert today — `grep -rl '^hooks:' packages/cli/src/agents/*/*/metadata.yaml` returns nothing — but a consuming project's agent declaring its own `PostToolUse` or `Stop` hook previews without it while `install` writes it, which is the editor/CLI divergence the two surfaces are meant never to have. The completion gate is unaffected (composed from `tools` inside `renderAgent`). Fix is one field in the `Pick` plus `bun run generate:matrix`, then the fifth spread in the editor. Found by the lane landing the other four; the earlier lane that added `isolation`/`experimental` to that type stopped short of `hooks`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Ready for Dev    | bug      | easy       |
| CLI-883 | (new, 2026-09-03) **The editor and the CLI build a compiled agent's `AgentConfig` by two hand-aligned functions, and nothing compares their outputs.** `compileAgents` in `apps/editor/src/features/configure/lib/output-preview.ts` and `resolveAgents` in `packages/cli/src/cli/lib/resolver.ts` each construct the definition `renderAgent` consumes; `renderAgent`'s byte-identity for the SAME input is pinned (`scripts/generate-compile-package.test.ts`), but no test feeds one configuration through both constructors and asserts the two `AgentConfig`s agree. So every field is aligned by a person reading both files — five conditional spreads were mirrored by hand this week, `model`/`path` are deliberately unconditional on one side, and `hooks` cannot be mirrored at all (CLI-882). The divergence class is the one the two surfaces are meant never to have, and it is currently guarded by nothing. The comparator belongs beside `preview-matches-install.e2e.test.ts`, whose docblock now records this as a KNOWN GAP; the shape is a contract test in `packages/compile` that both front doors import, or an e2e that installs and previews one config and `toStrictEqual`s the two constructed definitions before rendering. Found by the lane that fixed that spec's own vacuous version check.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Ready for Dev    | test     | medium     |
...
#### CLI-865: `summary-panel.test.tsx` fails about 1 run in 10 under CPU contention

Measured during CLI-863: 9/10 green with `test` and `test:e2e` concurrent, 6/6 green with the unit
suite alone. The failing assertion expects `4 more below` and gets `3 more below`.

**The cause this row was filed with is FALSIFIED, and it had been copied into two other artefacts.**
The row claimed a shared-singleton isolation defect, on the grounds that the frame rendered
`Marketplace  All skills ejected` and that branch needs a matrix lacking the skill. It does not:
`buildSkillConfigs` in `__tests__/helpers/wizard-simulation.ts` sets
`origin: overrides?.origin ?? "eject"` unconditionally and never reads the matrix, so the scrolling
`beforeEach`'s `buildSkillConfigs(["web-framework-react"])` is all-eject on EVERY run and
`formatSkillMarketplaces` renders that label in the green runs too. The frame the row treated as
diagnostic is the normal frame.

The claim was struck from `.husky/pre-push`'s header and from `archive.md`'s CLI-863 entry on
2026-09-02, at the same time as this row.

**The live candidate is the one the row explicitly denied.** `use-panel-scroll.ts` converges
`contentHeight` upward across measure cycles while the spec waits a fixed `RENDER_DELAY_MS = 100`,
so a starved process reads one line short. Any fix is pre-refused from lengthening the delay — two
`archive.md` entries already ruled on that.

`Investigate` rather than `Ready for Dev`, alongside its siblings CLI-678 and CLI-750.

#### CLI-869: the wizard's own rendering is the half CLI-854 could not close

CLI-854 put one sanitiser behind three chokepoints — `truncateText`, `formatZodIssue` and
`getErrorMessage` — which closed every site that renders foreign text through a shared renderer. The
wizard does not: it interpolates `displayName` and friends into Ink components directly.

Re-derive the surface:

```
grep -rn 'displayName' packages/cli/src/cli/components packages/cli/src/cli/commands --include='*.tsx'
```

Known sites at the time of filing: `source-grid.tsx`, `category-grid.tsx`, `checkbox-grid.tsx`,
`step-agents.tsx`, `stack-selection.tsx` and `edit.tsx`.

**`Needs Assistance` because the two fixes differ in kind, not in size.**

1. **Sanitise once at `initializeMatrix`.** One edit, and every consumer inherits it. But
   `initializeMatrix` also feeds `seatCatalog`, so this changes what a **compiled agent body**
   contains for a hostile catalogue — a product change, not a display fix, and it needs a decision
   about whether a skill's authored name is allowed to differ between the file on disk and the
   agent that carries it.
2. **Patch at the render sites.** No blast radius beyond display, but it is roughly 499
   `displayName` occurrences across 19 files, and it leaves the class permanently reopenable by the
   next component that renders one.

Nothing about the choice is derivable from the code, which is why the lane named it and left it —
correctly, since inventing an answer here would have shipped a compiled-output change under a
terminal-escaping row.

#### CLI-868: a link to a dated plan reads as a dangling finding citation

`FINDING_NAME` in `packages/cli/scripts/check-finding-citations.ts` is
`/(?<![\w-])(20\d{2}-\d{2}-\d{2}-[a-z0-9][a-z0-9-]{10,})/g`, applied across `todo/`. **The
`todo/plans/` naming convention is date-first**, so any tracker linking a plan by name trips it —
two specs fail naming a "finding that is gone" which was never a finding.

Reproduced 2026-09-02 when `ROADMAP.md` gained a link to a dated plan under `todo/plans/`:
`check-finding-citations.test.ts` went 2 failed / 23 passed. Worked around by renaming that file to
drop its date prefix — and it has since been deleted, so the checker is green today for two reasons
and the trap is still there for the next dated plan a tracker links.

**It is the CLI-856 class — the failure names the wrong thing.** A reader sees "no tracker naming a
finding that is gone" and goes looking for a deleted finding. No existing tracker cites a dated plan,
so nothing had exercised this before.

The fix is a discriminator the regex does not have: a name reached through a link into
`todo/plans/` is a plan, not a finding. Cheap, and it removes a trap from a convention the repo
