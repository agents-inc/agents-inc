...
| test-infrastructure.md | 0 | 14 | OK | <!-- iter42 converted to pointer. Body was drifted (2026-04-13, missing dual-scope POM, waitForWizardFooter, BaseStep contract, test-fs-utils/expected-values splits) while testing/* children were current (2026-04-21). Now matches type-system.md pointer pattern. -->
...
| findings-impact-report.md | 0 | 30 | OK | <!-- 2026-07-24 incremental append: 4 D-226/D-219 E2E-harness findings added under Incremental Updates (finding→impacts table + actions + new Pattern N — launcher-must-match-scope); primary A..M tables intentionally unchanged per append flow; last_validated bumped to 2026-07-24; 99 findings on disk (95 in primary tables). Prior — FULL REGENERATION 2026-07-23: rebuilt rollups over 95 findings; window 2026-04-17..2026-07-23; systemic patterns re-lettered A..M; Incremental Updates reset; next full regen when >10 Incremental entries accumulate -->
...
| Findings Impact       | [DONE] | `reference/findings-impact-report.md`                                                                  | 2026-07-24   | 2026-07-24     | Full regen 2026-07-23 (95 findings); 2026-07-24 incremental append of 4 D-226/D-219 harness findings (primary tables unchanged, 99 on disk); next full regen >10 Incremental entries |
...
| E2E Infrastructure      | [DONE] | `reference/testing/e2e-infrastructure.md` | 2026-07-24   | 2026-07-24     | Validate in 14 days |
