...
A rough overview of the Agents Inc. CLI codebase. For granular implementation details, see the verified documentation in [`.ai-docs/`](../../../packages/cli/.ai-docs/DOCUMENTATION_MAP.md).
