/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c9ada5466addd2112e381c1ce76b04fd)
// Runtime types generated with workerd@1.20260730.1 2025-10-01 nodejs_compat
interface __BaseEnv_Env {
	CONFIGS: KVNamespace;
	DATABASE: D1Database;
	CONFIG_WRITES: RateLimit;
	COMPOSE_CALLS: RateLimit;
	WEB_ORIGIN: "https://agentsinc.sh" | "http://localhost:5173";
	GITHUB_CLIENT_ID: "Ov23liy1WGblcNBDJoXc" | "Ov23liHANitAG2b0NDXj";
	AUTH_BASE_URL: "https://api.agentsinc.sh" | "http://localhost:8787";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEB_ORIGIN" | "GITHUB_CLIENT_ID" | "AUTH_BASE_URL" | "SENTRY_INGEST_HOST" | "SENTRY_PROJECT_ID" | "GITHUB_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "ANTHROPIC_API_KEY" | "AI_GATEWAY_URL">> {}
}
