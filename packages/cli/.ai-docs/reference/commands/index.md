...
| Flag            | Type    | Description                                                                                                                                                                                                                             |
| --------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| --ui            | boolean | `default: false`. Open agentsinc.sh instead of the wizard, on whatever `--from` names. Given no `--from`, that is THIS installation, so an id is minted for it first; given one, the id already exists and nothing is minted or fetched |
