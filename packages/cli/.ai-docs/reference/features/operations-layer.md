...
| `loadAgentDefs`                    | `(options?: {projectDir?}) => Promise<AgentDefs>`                               | `getAgentDefinitions()` from `agents/index.js`, `loadMergedAgents()` from `loading/index.js`                                                                                                                                                                      | Merges CLI built-in agents with source agents (source overrides CLI). Internally passes `undefined` as the remote source — callers cannot override.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
