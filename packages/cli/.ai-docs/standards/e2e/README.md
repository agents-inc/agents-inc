...
| Status / progress        | `LOADING_SKILLS`, `RECOMPILING`, `NO_AGENTS_TO_RECOMPILE`, `AGENTS_REWRITTEN`, `UNCHANGED`, `COMPILE_GLOBAL_SCOPE_HINT`, `CONFIG_TYPES_REFRESHED`, `SKILL_NOT_FOUND_WARNING`, `COMPILE_PASS_NO_SKILLS`, `SOURCE_HAS_NEWER_CONTENT`, `SOURCE_UNREACHABLE_CACHED`, `COMPILE_NO_SKILLS_ERROR`, `COMPILE_METADATA_UNUSABLE`, `COMPILE_METADATA_MISSING_FIELD`, `PROPAGATED_RECOMPILE_ONE`, `PROPAGATED_RECOMPILE`, `LOADED`, `LOADED_SKILL`, `COMPILED_LIST`                                                                    |
...
| Prompts                  | `CONFIRM_UNINSTALL`, `SEARCH`, `UNINSTALL_PREVIEW`, `UNINSTALL_PREVIEW_HEADING`, `UNINSTALL_CONFIG_SECTION`, `UNINSTALL_PROJECTS_UPDATED_ONE`, `UNINSTALL_PROJECT_SKIPPED`, `UNINSTALL_CONFIG_UNREADABLE`, `UNINSTALL_NOTHING_TO_UNINSTALL`, `UNINSTALL_NOT_INSTALLED`, `UNINSTALL_NO_CHANGES_MADE`, `UNINSTALL_CLI_COMPILED`                                                                                                                                                                                               |
| Sources step / removal   | `SOURCE_DISPLAY_EJECT`, `METADATA_UNUSABLE_WAY_OUT`, `REMOVED_REASON_NOT_IN_SOURCE`, `REMOVED_REASON_FILES_GONE`, `UPDATE_NO_MARKETPLACES`, `UPDATE_MARKETPLACE_REFRESHED`, `INSTALL_MODE_LOCAL`, `INSTALL_MODE_PLUGIN`, `PANEL_MARKETPLACE`                                                                                                                                                                                                                                                                                |
| Scope group labels       | `SCOPE_GLOBAL`, `SCOPE_PROJECT`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Dashboard                | `DASHBOARD`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `doctor` layers          | `DOCTOR_CONTENT_SECTION`, `DOCTOR_OPERATIONAL_SECTION`, `DOCTOR_SKIP_AFTER_CONTENT_ERRORS`, `DOCTOR_SKIP_NO_INSTALLATION`, `DOCTOR_CONFIG_CHECK`, `DOCTOR_SUMMARY`, `DOCTOR_ROW_SKILLS_RESOLVED`, `DOCTOR_ROW_AGENTS_COMPILED`, `DOCTOR_ROW_NO_ORPHANS`, `DOCTOR_ROW_SKILLS_INSTALLED`, `DOCTOR_ROW_PLUGINS_INSTALLED`, `DOCTOR_ROW_SOURCE_REACHABLE`, `DOCTOR_CONFIG_IS_VALID`, `DOCTOR_SOURCE_LOCAL`, `DOCTOR_SKILLS_AVAILABLE`, `DOCTOR_AGENTS_NEED_RECOMPILATION`, `DOCTOR_SKILLS_VALIDATED`, `DOCTOR_AGENTS_VALIDATED` |
| `doctor` config verdicts | `DOCTOR_CONFIG_UNREADABLE`, `DOCTOR_CONFIG_NOT_FOUND`, `DOCTOR_CONFIG_DECLARES_NOTHING`, `DOCTOR_ONE_CONFIG_VALIDATED`, `DOCTOR_SKIPPED_CONFIG_INVALID`, `DOCTOR_NO_SKILLS_CONFIGURED`, `DOCTOR_NO_AGENTS_CONFIGURED`, `DOCTOR_UNOWNED_INSTALL`, `CONFIG_SOURCE_LOAD_NOISE`                                                                                                                                                                                                                                                 |
| `doctor` tips            | `DOCTOR_TIP_CREATE_CONFIG`, `DOCTOR_TIP_RECREATE_CONFIG`, `DOCTOR_TIP_NOTHING_CONFIGURED`, `DOCTOR_TIP_UNOWNED_INSTALL`, `DOCTOR_TIP_COMPILE_AGENTS`, `DOCTOR_TIP_CHECK_SKILL_IDS`, `DOCTOR_TIP_RE_EJECT`                                                                                                                                                                                                                                                                                                                   |
| UI elements              | `FOOTER_SELECT`, `FOOTER_HOTKEY_ROW`, `START_FROM_SCRATCH`, `TOGGLE_SELECTION`, `NO_INSTALLATION`                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Installation output      | `INSTALLING_PLUGINS`, `INSTALLING_PLUGINS_ELLIPSIS`, `PLUGIN_NATIVE`, `EJECT_LOCAL_COPY`, `SWITCHING_SKILLS_PREFIX`, `SWITCHING_SKILLS_SUFFIX`, `SKILLS_COPIED_TO`, `AGENTS_COMPILED_TO`, `CONFIGURATION_LABEL`, `READY_TO_INSTALL`, `NO_SKILLS_FOUND`, `UNINSTALL_CANCELLED`                                                                                                                                                                                                                                               |
| `init --from` refusal    | `SHARED_CONFIG_EXISTING_INSTALL`, `SHARED_CONFIG_GLOBAL_INSTALL`, `SHARED_CONFIG_UNINSTALL_HINT`, `SHARED_CONFIG_UNWRITABLE_PAIR`                                                                                                                                                                                                                                                                                                                                                                                           |
