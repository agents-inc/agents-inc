...
| --------------------- | ------ | ------------------------------------------------------------------------------------------------------ | ------------ | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Architecture Overview | [DONE] | `reference/architecture-overview.md`                                                                   | 2026-08-06   | **2026-07-30** | **PARTIAL 2026-08-06, date deliberately NOT moved:** `components/render.ts` added to the directory tree with the TTY/`interactive: true` rule and its five importers. Its three stacked annotations were collapsed into one per the bible's one-annotation rule. Sections 4-17 stand on 2026-07-30. Validate in 30 days                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Commands Reference    | [DONE] | `reference/commands/index.md` (canonical; `reference/commands.md` is now a pointer)                    | 2026-08-06   | **2026-07-30** | **NEEDS-VALIDATION DISCHARGED 2026-08-01.** **PARTIAL 2026-08-06, date deliberately NOT moved:** new "Every Ink render goes through `src/cli/components/render.ts`" subsection under Command Architecture, and the whole `FEATURE_FLAGS` inventory re-derived — the table listed **7** flags and claimed "no other flags exist" while source has **8** (`WIZARD_SETTINGS_OVERLAY` was missing), and the `Current Value` column is now `Default` because every flag is `envFlag(name, default)`. Validate in 14 days                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| Wizard Flow           | [DONE] | `reference/features/wizard-flow.md`                                                                    | 2026-08-06   | **2026-07-30** | PARTIAL 2026-08-01 x2 (`I`-hotkey gate, hook table, component tree). **PARTIAL 2026-08-06, date deliberately NOT moved:** the Feature Flags section's five wizard rows re-derived and the `envFlag` env-override paragraph added. Step progression / guards / scope toggles NOT re-checked. Validate in 14 days                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| Component Patterns    | [DONE] | `reference/component-patterns.md`                                                                      | 2026-08-06   | **2026-07-30** | **HIGHEST-PRIORITY DOC IN THE REPO.** 2 -> 10 findings this window, the largest jump on record. **Three** PARTIAL passes now (07-31, 08-01, 08-06) and still not re-stamped. 08-06 corrected `Ink v5` -> Ink 7.1.1 / React 19.2.8 (a wave-1 version string nothing swept) and added "Hooks are linted, with exactly two rules". **Schedule a FULL pass next**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Findings Impact       | [DONE] | `reference/findings-impact-report.md`                                                                  | 2026-08-06   | **2026-08-01** | **PARTIAL 2026-08-06, date deliberately NOT moved:** recommendation 22's three ESLint items all landed 2026-08-05 and are struck as such; no primary table re-derived. Prior — **FULL REGENERATION DONE 2026-08-01 — both triggers discharged** (23 findings past the 135-file snapshot, and the 0.146.1+0.147.0+0.147.1 bundle shipped). Every primary table rebuilt over ALL findings on disk; the 135-file basis is RETIRED, so there is one basis and no reconciliation is intended. Patterns A..U carried forward with widened statements for G, M, Q, R, S and T; **Pattern V newly named** (the artefact that looks like verification and cannot fail — the defining shape of all three releases). Incremental Updates is genuinely empty. **Finding counts are NOT restated in this map** — that file owns them per the count-ownership registry; read its snapshot-boundary callout, which also records that the basis moved DURING the pass and was re-derived at the close |

### New Files (Phase 2+3 restructure, 2026-04-13)

| Area                    | Status | File                                      | Last Updated | Last Validated | Next Action                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ----------------------- | ------ | ----------------------------------------- | ------------ | -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Test Infrastructure     | [DONE] | `reference/testing/infrastructure.md`     | 2026-08-06   | **2026-07-30** | PARTIAL 2026-08-01 and 2026-08-05. **PARTIAL 2026-08-06, date deliberately NOT moved:** `vitest.setup.ts`'s module-scope `delete process.env.CI` / `GITHUB_ACTIONS` documented (unit rendering is CI-independent by construction; the deletion must stay at module scope because `is-in-ci` reads the env once at import), plus the Ink 7 unconditional teardown-`\n` frame and why `summary-panel.test.tsx` reads joined `frames`. Its two stacked annotations were collapsed to one. Validate in 14 days                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| E2E Infrastructure      | [DONE] | `reference/testing/e2e-infrastructure.md` | 2026-08-06   | **2026-07-30** | **NEEDS-VALIDATION NARROWED, NOT CLEARED.** `STEP_TEXT` 64 -> **74** and all per-directory spec counts re-derived; POM inventories + all TIMEOUTS/paths still unchecked. **ADDITIVE 2026-08-04, date deliberately NOT moved:** the two references to `e2e/FINDINGS.md` were repaired (the file is retired) — the directory-tree line removed, and the `createPermissionsFile` row now states the reason inline (a static Ink element with no input handler) and points at `testing/harness-decisions.md` § 1.1. **Its per-directory spec counts are stale against the 2026-08-04 re-derivation** in Coverage Metrics; owned there, correct here on the next pass. **PARTIAL 2026-08-06, date deliberately NOT moved:** `retry: 2` -> **`1`** and `maxWorkers: 16` -> **`Math.min(16, os.availableParallelism())`**, both re-derived from `e2e/vitest.config.ts` with the measured numbers behind them; the retry came down because the flake it was tuned against was Ink's CI detection, fixed by the render wrapper. **Both `standards/` copies of these values were corrected in the same pass** (`e2e-testing-bible.md` § 1.4 and `e2e/test-structure.md`), so all three docs agree; this doc remains the owner. The two stacked annotations flagged on 2026-08-04 were collapsed to one by this pass |
...
| Area                   | Status | File                                           | Last Updated | Last Validated | Next Action                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------------------- | ------ | ---------------------------------------------- | ------------ | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Seed Contract          | [DONE] | `reference/features/seed-contract.md`          | 2026-08-06   | **2026-08-02** | **NEW, FULL 2026-08-02** — every file under `lib/seed/` read end to end plus BOTH copies of the vendored schema. Closes the `[NOT-STARTED]` area opened by the (b) pass. **PARTIAL 2026-08-06, date deliberately NOT moved: the "nothing automated links the two copies" trigger is NARROWED, not removed.** `lib/seed/seed-schema-drift.test.ts` (new 2026-08-05) now compares the vendored contract against `packages/matrix/src/seed.ts` by JSON-Schema projection, loading the canonical file through a computed dynamic import so tsc's rootDir never sees it. **It pins the SHAPE, not the `SEED_VERSION` bump** — two copies changed together and both left at v3 still pass, so the lockstep rule stays a convention for that half. Unit count re-derived by RUNNING vitest: 13/3 files -> **20/4 files**. Validate in 14 days                                                                                                                                  |
...
| Code Generation        | [DONE] | `reference/features/code-generation.md`        | 2026-08-06   | **2026-08-02** | **NEW, FULL 2026-08-02.** Owns the `SCHEMA_ENTRIES` count (10) and the `src/schemas/` file count (12) per the count-ownership registry — the 10-vs-12 gap IS the invariant. Records that `injectSubcategoryPropertyNames` is currently **inert** (findings Pattern V). **PARTIAL 2026-08-06, date deliberately NOT moved — this doc took the heaviest drift of any in the corpus.** Corrected: both generators now run under `bun` (`npx tsx` and `npm run` are gone from every script here); the new `generate:types:check`; `generate:schemas:check` now runs in CI's `check-cli`, so it is no longer a Pattern V artefact; `typecheck` is three tsc programs, closing Known-gap 1; the `generate:types` -> `packages/matrix generate` chain and the real 2026-08-05 CI failure it caused; traps 4 and 11 rewritten. Validate in 14 days                                                                                                                              |
...
| Build & Packaging      | [DONE] | `reference/build-and-packaging.md`             | 2026-08-06   | **2026-08-02** | **NEW, FULL 2026-08-02.** Owns the packaging counts; re-derive with `npm pack --dry-run --ignore-scripts --json` (the `--ignore-scripts` is load-bearing — `prepare` runs husky, which sets `core.hooksPath` via git). Two live gaps recorded: the built `config-loader` jiti alias resolves outside the installed package, and zero `.d.ts` ship. **PARTIAL 2026-08-06, date deliberately NOT moved:** the entry contract gained three negations so **no compiled test ships any more** (was 16); §6 figures re-derived at 0.151.0 (569 -> **517** entries, 405 -> **353** in `dist/`); §9's "there is no test that asserts anything about the package" is retired by `packaging.test.ts`; `typecheck` is three tsc programs and `prepublishOnly` carries the two generator checks; a new subsection covers what turbo hashes as build input. Its two stacked 08-05 annotations were collapsed to one. **Validate in 30 days**                                         |
...
| Area              | Status | File                                     | Last Updated | Last Validated | Next Action                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ----------------- | ------ | ---------------------------------------- | ------------ | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Monorepo Layout   | [DONE] | `reference/monorepo-layout.md`           | 2026-08-06   | **2026-08-04** | **NEW, FULL 2026-08-04.** Absorbs `docs/monorepo-merge.md`. The only doc here whose paths are repository-root-relative — stated in its body, do not normalise. **PARTIAL 2026-08-06, date deliberately NOT moved:** the syncpack paragraph said two split-era version groups survive — `.syncpackrc.cjs` is now `module.exports = {}` with none, and `deps:fix` is `syncpack fix` (`fix-mismatches` is gone in syncpack 15). CI section gained the `NODE_VERSION` pin, the three measured `timeout-minutes`, and the fact that the vendored-catalog check is **two** checks (untracked files first, because a diff cannot see a file that never existed). Its two stacked annotations were collapsed to one. Validate in 30 days, or immediately on a change to the root `package.json`, `.husky/pre-commit` or `ci.yml` |
| Harness Decisions | [DONE] | `reference/testing/harness-decisions.md` | 2026-08-06   | **2026-08-04** | **NEW, FULL 2026-08-04.** Absorbs what survived the retired `e2e/FINDINGS.md`. Owns no API surface. Its § 2 records three claims that file carried and that are FALSE against current source; its § 3 is an alternatives-rejected register. **ADDITIVE 2026-08-06, date deliberately NOT moved:** new § 1.9 — the harness passes `CI` / `GITHUB_ACTIONS` through **on purpose**, the reverse of what it used to do, so every CI run exercises the render wrapper that once let Ink's CI guess hang a suite for 49 minutes. **No doc in this corpus ever claimed the harness strips CI** (checked by grep across `reference/` and `standards/`); the invariant was simply undocumented. Validate in 30 days, or immediately on a change to `e2e/helpers/terminal-session.ts` or `lib/permission-checker.tsx`              |
...
| E2E Testing Bible             | `standards/e2e-testing-bible.md`      | 2026-03-25 | 2026-07-30   | PARTIAL 2026-08-06, deliberately NOT re-stamped: § 1.4's Vitest values corrected — `maxWorkers: 16` -> `Math.min(16, os.availableParallelism())` and `retry: 2` -> **`1`**, each with one clause of reasoning. `reference/testing/e2e-infrastructure.md` owns the values. Prior: PARTIAL 2026-08-01; rewritten 2026-07-30 (inverted `HOME=cwd` claims removed)                                                                                                                                                                                                               |
| E2E Sub-Standards             | `standards/e2e/` (7 files)            | 2026-03-25 | 2026-07-30   | All 7 still at 2026-07-30. **Five received dated PARTIAL passes 2026-08-01 and correctly did NOT re-stamp** (README, anti-patterns, assertions, page-objects, test-data); `patterns.md` and `test-structure.md` were untouched. `README.md`'s `STEP_TEXT` count is corrected to **74** and now agrees with `reference/testing/e2e-infrastructure.md`. **PARTIAL 2026-08-06 over `test-structure.md` only, deliberately NOT re-stamped:** its parallelism paragraph said `maxWorkers: 16`; it now reads `Math.min(16, os.availableParallelism())` with the lower-bound reason |
...
### ESLint: gate closed and baseline at ZERO (re-verified 2026-08-06, under the new rules)

> **Re-verified 2026-08-06 by running `npx eslint .` from `packages/cli` — no output, exit `0`.**
> That matters more than the earlier run: three rule layers landed since (`react-hooks`,
> `reportUnusedDisableDirectives`, the test-file task-ID ban), and each of them can only add
> problems. The baseline is still zero with all three active.
...
`coverage/`, `.cache/`, `.claude_backup/`, `todo/` and `src/cli/types/generated/`. The base is the
stock `js.configs.recommended` + `tseslint.configs.recommended` presets, and
`eslint-config-prettier` is applied last so ESLint never reports formatting.

**The config is no longer "stock plus one override" — corrected 2026-08-06.** That description was
true when written and has been false since 0.151.0. What is layered on top of the presets:
...
| `@typescript-eslint/no-unused-vars`                         | All TS sources                                             | Honours the leading-underscore convention in `standards/clean-code-standards.md` § 9.6                                                                   |
| `eslint-plugin-react-hooks`                                 | `src/cli/**/*.tsx`, `components/**/*.ts`, `stores/**/*.ts` | `rules-of-hooks` + `exhaustive-deps`, both `error`. **Exactly those two** — the v7 recommended set's React-Compiler rules outlaw Ink's measurement idiom |
| `no-restricted-syntax` (task IDs)                           | Test files and fixtures                                    | Bans `D-`/`R-`/`P*-`/`CLI-`/`REPO-`/`WWW-`/`ED-`/`SRV-` + digits in `describe`/`it`/`test` names and `expect` messages                                   |
| `@typescript-eslint/triple-slash-reference: off`            | `**/*.d.ts`                                                | Correct idiom in a declaration file; for `@lydell/node-pty` it is the only option                                                                        |
| `no-restricted-imports` / `no-restricted-syntax` (L2 zones) | Five nested zones                                          | The config-gate enforcement layer — private-module bans, raw-write bans, pair-renderer bans                                                              |

`reference/component-patterns.md` carries the react-hooks carve-out argument and the five hook files
it changed; `reference/boundary-map.md` § 3.4a carries the config-gate enforcement layers.
...
**Residual gaps — ALL THREE ESLint entries here are now CLOSED (2026-08-05, verified 2026-08-06).**
They are kept as lineage, struck rather than deleted, because each names a real gap that an agent may
still meet quoted in an older document:

- ~~**`eslint-plugin-react-hooks` is NOT installed.**~~ **CLOSED.** It is wired over
  `src/cli/**/*.tsx`, `src/cli/components/**/*.ts` and `src/cli/stores/**/*.ts` with
  `rules-of-hooks` and `exhaustive-deps`. Five hook files changed to satisfy it; two carry justified
  `eslint-disable-next-line react-hooks/exhaustive-deps` on the measure-every-render effects.
  **Only those two rules, deliberately** — see `reference/component-patterns.md`.
- ~~**`reportUnusedDisableDirectives` is not enabled.**~~ **CLOSED.** It is `"error"` repo-wide, which
  is what makes the two disables above safe: a directive whose rule stops firing now fails the run.
- ~~**No `no-restricted-syntax` rule for task-IDs in test names.**~~ **CLOSED.** Test files and
  fixtures reject task IDs in `describe`/`it`/`test` names and in `expect` messages. Three specs lost
  their IDs when it landed (`source-loader.test.ts`, `resolver.test.ts`,
  `d227-same-scope-tombstone-duplicate.test.ts`). File-level JSDoc is the sanctioned home for an ID —
  the rule cannot see comments. `agent-findings/2026-07-17-d167-task-id-recurrence-no-lint-guard.md`
  is closed by this.
...
- **Generator drift is now checked — NARROWED, not closed (corrected 2026-08-06).** This bullet said
  the generators appear in `prepublishOnly`, `.husky/pre-commit` and the workflows **zero** times.
  That is false as of 0.151.0. `generate:schemas:check` runs in CI's `check-cli` job **and** in
  `prepublishOnly`; a new `generate:types:check` runs in `prepublishOnly` **only**, because
  `generate:types` reads the sibling `skills` checkout that no runner has — do not "complete the
  pair" in CI. `typecheck` now runs three tsc programs (`tsconfig.json`, `tsconfig.scripts.json`,
  `e2e/tsconfig.json`), so `typecheck:scripts` is no longer outside every composite gate either, and
  the untypechecked-`scripts/` gap that hid a phantom field and two fabricated SkillIds is closed.
  **What remains genuinely open:** neither check runs at pre-commit, so a stale artefact can sit on
  `main` until the next CI run (schemas) or the next publish (types). See
  `reference/features/code-generation.md`, whose Known-gaps 1 and 2 carry the full lineage.
...
**Source Files:** **371** TypeScript files in `src/cli/` — **194** production (excludes `*.test.*`, `__tests__/`, `__mocks__/`) + **139** test specs (`*.test.*`) + **36** non-spec `__tests__/` support files + **2** `__mocks__/`. (The `__tests__/` directories hold 86 files total: 50 specs + 36 support.) **Re-derived with `find` on disk 2026-08-06** (was 367 / 193 / 136 / 36 / 2 on 2026-08-04). The +4 is the 0.150.0/0.151.0 repo-tracker batch: `components/render.ts` (production) plus `lib/feature-flags.test.ts`, `lib/seed/seed-schema-drift.test.ts` and `lib/__tests__/packaging.test.ts` (specs). **Paths are now `packages/cli/src/cli/`**; the bare `src/cli/` form is kept here because every other doc in this corpus uses it — see `reference/monorepo-layout.md`, which is the one deliberate exception.
**E2E Suite:** **219** TypeScript files in `e2e/` (**181** `*.test.ts(x)` + **38** helpers/fixtures/pages) — **re-derived with `find` on disk 2026-08-06 and unchanged from 2026-08-04**. Of the 181: **178** `*.e2e.test.ts` + **3** `*.smoke.test.ts`. Per directory: `commands` 39, `interactive` 56, `lifecycle` 78, `integration` 3, `matchers` 1, `smoke` 1 e2e + 3 smoke. **`matchers/` holds one spec and is easy to miss** — a per-directory sum that omits it lands one short of the total, which is how a previous basis reconciled while being wrong.
...
### 2026-08-06 -- repo-tracker + CLI-tracker batch absorption (PARTIAL, no dates advanced)

Drift pass over the two batches that landed after the 2026-08-05 tool-version work: the repo-tracker
batch (render wrapper, packaging guard, turbo inputs, three-program typecheck, generator checks, CI
timeouts, syncpack) and the CLI-tracker refactors (env-overridable feature flags, the react-hooks and
task-ID lint rules, the seed drift test).

**Scope: twelve reference docs and this map. No `src/`, `e2e/`, `todo/`, `standards/` or package file
touched, no dependency or config changed, and no git command of any kind run.** Nothing re-derived a
whole file, so **no `last_validated` was advanced**; every touched doc carries a dated
`VALIDATED 2026-08-06 · PARTIAL` annotation naming exactly what was checked.

| Doc                             | What its claims now say                                                                                                                                                                 |
| ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `commands/index.md`             | New: every Ink render goes through `components/render.ts`, never `ink`. `FEATURE_FLAGS` is 8 flags with `AGENTSINC_FLAG_<NAME>` overrides — was 7 with a false "no other flags exist"   |
| `architecture-overview.md`      | `components/render.ts` in the directory tree, with the TTY rule and its five importers                                                                                                  |
| `component-patterns.md`         | Ink 7.1.1 / React 19.2.8 (was `Ink v5`); hooks are linted by exactly two react-hooks rules, and why the v7 recommended set is refused                                                   |
| `features/wizard-flow.md`       | Flag defaults are overridable at runtime; the read is at module load because tsup inlines literals                                                                                      |
| `build-and-packaging.md`        | Entry contract has three negations, so no compiled test ships (was 16); `packaging.test.ts` pins it; §6 figures re-derived at 0.151.0; `typecheck` is three programs; what turbo hashes |
| `features/code-generation.md`   | Both generators run under `bun`; two checks exist; `generate:schemas:check` runs in CI; `typecheck` covers `scripts/`; the two-generator chain and the CI failure it caused             |
| `monorepo-layout.md`            | Zero syncpack version groups; `deps:fix` is `syncpack fix`; CI has a Node pin, three measured timeouts, and a two-part vendored-catalog check                                           |
| `testing/infrastructure.md`     | `vitest.setup.ts` deletes `CI` / `GITHUB_ACTIONS` at module scope; the Ink 7 teardown frame is unconditional, so assert on joined `frames`                                              |
| `testing/harness-decisions.md`  | New § 1.9 — the harness passes `CI` / `GITHUB_ACTIONS` through **on purpose**, so every CI run exercises the render wrapper                                                             |
| `testing/e2e-infrastructure.md` | `retry: 1` (was 2) and a two-ended worker cap, both with the measurements behind them                                                                                                   |
| `features/seed-contract.md`     | `seed-schema-drift.test.ts` links the two copies of the wire contract by JSON-Schema projection — it pins the shape, **not** the `SEED_VERSION` bump                                    |
| `findings-impact-report.md`     | Recommendation 22's three deferred ESLint items are struck as LANDED; every primary table untouched and still on its 2026-08-01 FULL basis                                              |

**One claim in this pass's own brief was checked and found FALSE.** The brief named
`harness-decisions.md` § 1.1 as certainly falsified, on the grounds that some doc described the E2E
harness stripping `CI`. It does not: § 1.1 is about the post-install permission notice having no exit
of its own, and a grep for `CI` / `GITHUB_ACTIONS` / `is-in-ci` across all of `reference/` and
`standards/` finds **no doc that ever made that claim**. The passthrough was an undocumented
invariant, not a drifted one, so § 1.9 is an addition rather than a correction. Recorded because "the
known certain one" is exactly the kind of instruction a later pass would take on trust.

**Four stale claims were found and corrected that no part of the brief predicted**, all of them
version strings or exhaustiveness claims that only reading the source finds: `component-patterns.md`'s
`Ink v5` (a wave-1 miss); `commands/index.md`'s 7-flag inventory asserting "no other flags exist";
`monorepo-layout.md`'s two surviving syncpack version groups; and `code-generation.md`'s `npx tsx` /
`npm run` script definitions.

**Three files were carrying stacked validation annotations, which
`standards/documentation-bible.md`'s one-annotation rule forbids** (`architecture-overview.md` had
three, `build-and-packaging.md` and `monorepo-layout.md` two each, `testing/infrastructure.md` two,
`testing/e2e-infrastructure.md` two). Each was collapsed into a single annotation that names every
surviving basis by date, so nothing was lost. The 2026-08-04 note flagging this on
`e2e-infrastructure.md` is discharged.

**Judged not worth documenting, deliberately:** the third occurrence of the stale-install trap
(`@types/node` 24 in the manifest, a nested 22 winning) — `monorepo-layout.md` already records two
occurrences and its guidance, "run the tool and read the version it prints", is unchanged by a third,
so adding it would grow the section without changing what a reader does. The eight
`preserve-caught-error` fixes and the individual React type-signature changes were already judged
situational by the 2026-08-05 pass and remain so.

**Two `standards/` files carried the same drift and were corrected in a follow-up, not deferred**
(scope extended by the coordinator mid-pass): `standards/e2e-testing-bible.md` § 1.4 said
`maxWorkers: 16` and `retry: 2`, and `standards/e2e/test-structure.md`'s parallelism paragraph said
`maxWorkers: 16`. Both now read `Math.min(16, os.availableParallelism())` and `retry: 1`, each with
one clause of reasoning — the cap takes the lower bound so a 4-core runner gets 4, and the retry
dropped after the suite measured green at retry 0. Both carry a dated `VALIDATED 2026-08-06 ·
PARTIAL` annotation and **neither `last_validated` was advanced**; both remain 2026-07-30.
`reference/testing/e2e-infrastructure.md` owns the values, and the three now agree.
