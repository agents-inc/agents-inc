...
1. Did the step do what it was for? Investigation means you can name the patterns; implementation
   means the code matches them; testing means the tests cover the requirements, including what the
   pipeline does when the model's output is not what it expected.
