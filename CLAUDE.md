...
| `packages/api-mocks` | one MSW description of that worker, resolved by every suite that mocks it |
| `packages/ui`        | the design system the editor and the site both build on                   |
